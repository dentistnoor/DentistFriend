...
def main():
    ...
    if st.session_state["logged_in"]:
        ...
        # with col4:
        #     if st.button("Delete Account", icon="🗑", use_container_width=True):
        #         delete_account()
...
def show_support():
    st.markdown("## ❤ Support Dentist Friend")
    st.markdown("""
...
def delete_account():
    ...
    # if st.button("Confirm Deletion", icon="⚠", use_container_width=True):
    #     try:
