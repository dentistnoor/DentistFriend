...
def main():
    ...
    if register_button:
        if patient_fullname and patient_age and file_id:
            patient_info = {
                ...
                'file_id': file_id,
                'treatment_plan': [],
                'dental_chart': {}  # Store dental chart data
            }
    ...
    if st.session_state.patient_status:
        ...
        with st.container(border=True):
            ...
            # Initialize dental chart from patient data if available
            ...
            # Update teeth_map with stored values
            ...
            for teeth_row in teeth_rows:
                ...
                for i, tooth_number in enumerate(teeth_row):
                    with column_array[i]:
                        ...
                        # Check if condition changed and update dental chart
            ...
            if chart_changed:
                doctor_reference = data_base.collection('doctors').document(st.session_state.doctor_email)
                patient_document = doctor_reference.collection('patients').document(file_id)
        ...
        if st.session_state.treatment_record:
            # Create DataFrame from treatment record
            ...
            if not data_frame.empty:
                ...
                # Display the treatment schedule
